...
export class CreateMarketPriceDto {
  ...
  @ApiPropertyOptional({
    example: 'Mbarali Central Market',
    description: 'Market location where price was recorded',
  })
  @IsString()
  @IsOptional()
  market?: string;
  ...
  @ApiPropertyOptional({
    example: 'Ministry of Agriculture Board',
  ...
  @ApiProperty({
    ...
    description: 'Date and time when price was recorded',
  })
  @IsDateString()
  recordedAt: string;
}
